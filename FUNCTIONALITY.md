...
4) Surface via Streamlit UI, Telegram bot, CLI (and optional Research API)
...
## Commands
- Web UI: `streamlit run src/web/app.py`
...
# PrisMind Core Functionality

## Overview

PrisMind is an autonomous intelligence system that discovers, analyzes, and curates content from various sources with zero manual bookmarking. This document describes the core functionality that is working and should be maintained.
...
Users can interact with PrisMind through:

1. **Web Dashboard**: Streamlit-based interface for browsing content and system status
...
### Core Collection
- [src/core/extraction/multi_topic_sources.py](file:///Users/mac/Documents/Development/prismind/src/core/extraction/multi_topic_sources.py) - Defines content sources across categories
- [src/core/extraction/article_extractor.py](file:///Users/mac/Documents/Development/prismind/src/core/extraction/article_extractor.py) - RSS feed processing
- [run_full_collection.py](file:///Users/mac/Documents/Development/prismind/run_full_collection.py) - Main collection pipeline

### Analysis and Storage
- [src/services/autonomous_discovery.py](file:///Users/mac/Documents/Development/prismind/src/services/autonomous_discovery.py) - Core discovery logic
- [src/services/new_database_manager.py](file:///Users/mac/Documents/Development/prismind/src/services/new_database_manager.py) - Database operations abstraction
- [src/supabase_manager.py](file:///Users/mac/Documents/Development/prismind/src/supabase_manager.py) - Supabase integration

### User Interfaces
- [src/web/app.py](file:///Users/mac/Documents/Development/prismind/src/web/app.py) - Main web dashboard
- [src/services/telegram_bot.py](file:///Users/mac/Documents/Development/prismind/src/services/telegram_bot.py) - Telegram bot implementation
- [main.py](file:///Users/mac/Documents/Development/prismind/main.py) - Main entry point
