...
OUTPUT_PATH = Path(os.getenv("THREADS_COOKIES_FILE", "/Users/mac/Documents/Development/prismind/config/threads_cookies.json"))


async def _wait_for_user_confirmation(prompt: str = "\nWhen you finish logging in (profile visible), press Enter here... ") -> None:
...
def main() -> None:
    ...
    if not username or not password:
        raise SystemExit("THREADS_USERNAME and THREADS_PASSWORD must be set in env/.env")
