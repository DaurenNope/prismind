"""
PrisMind Performance Monitoring System
====================================

Comprehensive performance monitoring for the PrisMind application.
...
class AlertManager:
    ...
    def _evaluate_rule(self, rule: Dict[str, Any], collector: MetricsCollector) -> Optional[Dict[str, Any]]:
...
class PerformanceMonitor:
    ...
    def get_dashboard_data(self) -> Dict[str, Any]:
        ...
        return {
            'system_metrics': [
                m.to_dict() for m in self.metrics_collector.get_recent_system_metrics(minutes=5)
            ],
            'api_performance': self.metrics_collector.get_api_performance_summary(hours=1),
            'operation_performance': self.metrics_collector.get_operation_performance_summary(hours=1),
    ...
    def export_metrics(self, filepath: str):
        ...
        data = {
            ...
            'operation_metrics': [m.to_dict() for m in self.metrics_collector.operation_metrics],
            'active_alerts': list(self.alert_manager.active_alerts.values()),
