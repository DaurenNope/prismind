...
class ThreadSummarizerAI:
    ...
    def summarize_with_ollama(self, content: str, author: str, platform: str) -> ThreadSummary:
    ...
    def summarize_with_mistral(self, content: str, author: str, platform: str) -> ThreadSummary:
    ...
    def summarize_with_gemini(self, content: str, author: str, platform: str) -> ThreadSummary:
    ...
    def _create_summarization_prompt(self, content: str, author: str, platform: str) -> str:
    ...
    def _create_fallback_summary(self, content: str, author: str, platform: str) -> ThreadSummary:
