...
class ContentAnalyzer:
    ...
    def analyze_post(self, post: SocialPost) -> Dict[str, Any]:
        ...
        try:
            ...
            learning = self.insight_generator.generate_learning_recommendations({}, post)
            ...
            return {
                ...
                'is_rewrite_candidate': self.scorer.determine_rewrite_candidate({}, post, quality_score)
            }
...
class ContentScorer:
    ...
    @staticmethod
    def determine_rewrite_candidate(analysis: Dict, post: SocialPost, quality_score: float) -> bool:
...
class InsightGenerator:
    ...
    @staticmethod
    def generate_learning_recommendations(analysis: Dict, post: SocialPost) -> Dict[str, Any]:
...
class TimeSensitivityDetector:
    ...
    @staticmethod
    def detect_time_sensitivity(post: SocialPost, analysis: Dict[str, Any]) -> Dict[str, Any]:
