...
class SocialPost:
    ...
    def to_dict(self) -> Dict:
        ...
        if self.saved_at and isinstance(self.saved_at, datetime):
        ...
        if self.content:
            ...
            data['title'] = first_line[:100] if len(first_line) <= 100 else first_line[:97] + '...'
        else:
...
class SocialExtractorBase(ABC):
    ...
    def __init__(self, api_key: str = None, access_token: str = None):
        ...
        from src.core.normalization.markitdown_normalizer import get_markitdown_normalizer
