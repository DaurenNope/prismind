...
class ResearchEngine:
    ...
    async def search(
        ...
        try:
            ...
            for post in filtered_posts:
                result = self.search_filters.post_to_search_result(post, query, search_type)
    ...
    async def get_recent_posts(self, platform: Optional[str] = None, limit: int = 20) -> List[Dict[str, Any]]:
    ...
    async def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            platform_stats = {row['platform']: row['count'] for row in platform_results} if platform_results else {}
