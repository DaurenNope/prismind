...
class ContentAnalyzer:
    ...
    def categorize_content(self, content: Dict[str, Any]) -> str:
        ...
        try:
            ...
            # Technology category
            tech_keywords = ['programming', 'code', 'software', 'ai', 'machine learning', 'data', 'algorithm']
            if any(keyword in text_lower for keyword in tech_keywords):
                return 'technology'
            
            # Business category
            business_keywords = ['business', 'startup', 'entrepreneur', 'marketing', 'sales', 'finance']
            ...
            # Science category
            science_keywords = ['research', 'study', 'science', 'experiment', 'analysis']
            if any(keyword in text_lower for keyword in science_keywords):
                return 'science'
            
            # Personal development
            personal_keywords = ['learning', 'growth', 'development', 'mindset', 'productivity']
            ...
            print(f"⚠️ Error categorizing content: {e}")
    ...
    def analyze_content_collection(self, contents: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        print(f"📊 Analyzing collection of {len(contents)} items")
        ...
        # Generate summary
        summary = self._generate_collection_summary(quality_analysis, trend_analysis, gap_analysis, insights)
        
        # Generate recommendations
        recommendations = self._generate_collection_recommendations(quality_analysis, gap_analysis)
    ...
    def _generate_collection_summary(self, quality_analysis, trend_analysis, gap_analysis, insights) -> str:
        ...
        if improvement_areas:
            summary_parts.append(f"{len(improvement_areas)} improvement recommendations")
        
        return ". ".join(summary_parts) + "."
    
    def _generate_collection_recommendations(self, quality_analysis, gap_analysis) -> List[str]:
