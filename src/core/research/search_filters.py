...
class SearchFilters:
    ...
    def post_to_search_result(self, post: Dict, query: str, match_type: str) -> SearchResult:
        ...
        try:
            ...
            print(f"⚠️ Error converting post to search result: {e}")
    ...
    def _calculate_relevance_score(self, post: Dict, query: str, match_type: str) -> float:
