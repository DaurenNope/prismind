...
class ContentValidator:
    ...
    def validate_content(self, content_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            scores = [s for s in [structure_score, quality_score, duplicate_score, metadata_score] if s is not None]
            if scores:
            ...
            logger.info(f"Content validation: score={result['score']:.2f}, valid={result['valid']}")
    ...
    def _validate_structure(self, content_data: Dict[str, Any], result: Dict[str, Any]) -> float:
    ...
    def _validate_quality(self, content_data: Dict[str, Any], result: Dict[str, Any]) -> float:
        ...
        if quality_result['score'] < 0.8:
            result['warnings'].append(f"Low quality score: {quality_result['score']:.2f}")
        
        return quality_result['score']
    
    def _check_duplicates(self, content_data: Dict[str, Any], result: Dict[str, Any]) -> float:
    ...
    def _validate_metadata(self, content_data: Dict[str, Any], result: Dict[str, Any]) -> float:
    ...
    def batch_validate(self, content_list: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
