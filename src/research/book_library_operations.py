#!/usr/bin/env python3
"""
Book Library Operations for PrisMind
...
class BookLibraryOperations:
    ...
    def _load_index(self):
        ...
        if self.index_file.exists():
            try:
                ...
                print(f"✅ Loaded {len(self.entries)} books from index")
            except Exception as e:
                print(f"⚠️ Error loading book index: {e}")
                self.entries = {}
        else:
            print("📁 No book index found, starting fresh")
    ...
    def _save_index(self):
        ...
        try:
            ...
            print(f"✅ Saved {len(self.entries)} books to index")
        except Exception as e:
            print(f"⚠️ Error saving book index: {e}")
    ...
    def add_book(self, file_path: str, book: Book, tags: List[str] = None, notes: str = None) -> bool:
        ...
        try:
            ...
            if file_hash in self.entries:
                print(f"⚠️ Book already exists in library: {book.title}")
                return False
    ...
    def remove_book(self, file_hash: str) -> bool:
        ...
        try:
            if file_hash in self.entries:
                ...
                self._save_index()
                print(f"✅ Removed book: {entry.book.title}")
                return True
            else:
                print(f"❌ Book not found: {file_hash}")
                return False
        except Exception as e:
    ...
    def update_book_metadata(self, file_hash: str, **kwargs) -> bool:
        ...
        try:
            ...
            self._save_index()
            print(f"✅ Updated metadata for: {entry.book.title}")
            return True
    ...
    def export_library(self, export_path: str) -> bool:
        ...
        try:
            ...
            print(f"✅ Exported library to: {export_path}")
            return True
    ...
    def import_library(self, import_path: str) -> bool:
        ...
        try:
            ...
            self._save_index()
            print(f"✅ Imported {imported_count} books from: {import_path}")
            return True
