...
try:
    ...
    print("Warning: sentence-transformers not available. Semantic search will be limited.")
...
class SemanticSearchEngine:
    ...
    def __init__(self, model_name: str = "all-MiniLM-L6-v2"):
        ...
        if SENTENCE_TRANSFORMERS_AVAILABLE:
            ...
            print("Semantic search capabilities limited due to missing dependencies.")
    ...
    def add_documents(self, documents: List[str]):
        ...
        if SENTENCE_TRANSFORMERS_AVAILABLE and self.model:
            ...
            print("Cannot add documents: sentence-transformers not available or model not loaded.")
    ...
    def search(self, query: str, top_k: int = 5) -> List[SearchResult]:
        ...
        """
        if not SENTENCE_TRANSFORMERS_AVAILABLE or self.model is None or self.embeddings is None:
