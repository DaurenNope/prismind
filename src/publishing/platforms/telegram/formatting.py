...
from src.utils.github_metadata import get_github_metadata, format_github_display
...
def format_github_post(post: Any, index: int = 1) -> str:
    ...
    try:
        ...
        content = _get_field(post, 'content', _get_field(post, 'title', 'GitHub repository')) or 'GitHub repository'
...
def format_post_stats(posts: list) -> str:
    ...
    qualities = [q for q in (_quality_of(p) for p in posts) if isinstance(q, (int, float))]
...
def test_formatting():
    ...
    print("Regular Post:")
    print(format_post_for_telegram(post1, 1))
    print()
    ...
    print("GitHub Post:")
    print(format_post_for_telegram(post2, 2))
    print()
    ...
    # Test stats
    print("Stats:")
    print(format_post_stats([post1, post2]))
