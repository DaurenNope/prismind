...
class CompatRewriter:
    ...
    With:
        from src.publishing.modular_rewriter.compat import create_compat_rewriter
    ...
    def __init__(self, modular_rewriter: Optional[ModularRewriter] = None):
        self._rewriter = modular_rewriter or ModularRewriter()
    ...
    async def rewrite_analyzed_post(
        ...
        **kwargs
        ...
        result = await self._rewriter.rewrite(request)
